...
export function Topbar() {
  ...
  const openPalette = () => window.dispatchEvent(new Event("nsms:open-palette"));
      ...
      <div className="h-full flex items-center gap-3 px-4 md:px-6">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Link to="/profile" className="ml-1">
            <img src={profile.avatar} alt="" className="h-9 w-9 rounded-full object-cover ring-2 ring-border hover:ring-primary/60 transition" />
          </Link>
        </div>
      </div>
    </header>
